...
To judge the quality of the reproduction, we can write a function to compare how the difference between the reproduction and the desired result changes as we vary $$$ n-terms $$$.
